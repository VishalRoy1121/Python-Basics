# WAP to create a class named restaurant, with attributes like menu_items, book_table, customer_order and design suitable methods to perform :-
# Add items to the menu
# Make table reservations
# Take customer orders
# Print all
# (Use distionaries and lists to store the data)
